    ...
    <div class="login-wrapper " >
      ...
      <div class="login-container bg-white"  style="border-left:5px solid forestgreen">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          <img src="assets/img/ghsLogo.jpg" alt="logo" data-src="assets/img/ghsLogo.jpg" data-src-retina="assets/img/ghsLogo.jpg">
          ...
          <form id="form-login" class="p-t-15" role="form" action="index.html">
            ...
            <div class="form-group form-group-default">
              <label>Email</label>
              <div class="controls">
                <input type="text" name="username" placeholder="ama.mantebea@nbs.com" class="form-control" required>
              </div>
            </div>
            <!-- END Form Control-->
            <!-- START Form Control-->
            ...
            <!-- END Form Control-->
            <button class="btn btn-primary btn-cons m-t-10" type="submit" style="background-color: forestgreen; border-color: forestgreen">Sign in</button>
          </form>
          <!--END Login Form-->
